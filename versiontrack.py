...
from config import NUM_VERSIONS_TO_KEEP, DATABASE_URL # Import the configuration variable
from sqlalchemy.orm import configure_mappers
from sqlalchemy import (DateTime, Date,Column, ForeignKey, Integer, JSON, LargeBinary,
                        String, Table, and_, create_engine, func, or_, text, Float, Text)
