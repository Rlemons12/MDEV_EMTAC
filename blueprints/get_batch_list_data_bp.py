...
get_batch_list_data_bp = Blueprint('get_batch_list_data', __name__)
...
@get_batch_list_data_bp.route('/get_batch_list_data')
def get_list_data():
    # Create a session
    session = Session()

    try:
        print(f'batch # Query the database to get all areas, equipment groups, models, asset numbers, and locations')
