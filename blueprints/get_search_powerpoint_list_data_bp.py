...
get_search_powerpoint_list_data_bp = Blueprint('get_search_powerpoint_list_data_bp', __name__)
...
@get_search_powerpoint_list_data_bp.route('/get_powerpoint_list_data_bp')
def get_list_data():
    # Create a session
    session = Session()
    ...
    try:
        ...
        asset_numbers_list = [{'id': asset_number.id, 'number': asset_number.number, 'model_id': asset_number.model_id} for asset_number in asset_numbers]
